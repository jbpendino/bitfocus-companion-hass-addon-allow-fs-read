...
# Start new
exec /docker-entrypoint.sh node --allow-fs-read=* dist/index.js --admin-address 0.0.0.0 --admin-port 8000 --config-dir "/companion" --extra-module-path /app/module-local-dev
